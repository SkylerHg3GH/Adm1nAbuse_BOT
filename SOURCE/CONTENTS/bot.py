...
cfg = yaml.safe_load(open(r'C:\Users\skyler\AppData\Roaming\.minefabricnew\minescript\system\exec\Bot\config.yml', 'r+'))["bot"]
...
bans = yaml.safe_load(open(r'C:\Users\skyler\AppData\Roaming\.minefabricnew\minescript\system\exec\Bot\bans.yml'))
    ...
    while True:
        ...
        if e.type == ms.EventType.CHAT:
            try:
                ...
                try:
                    with open(r'C:\Users\skyler\AppData\Roaming\.minefabricnew\minescript\system\exec\Bot\bal.json', 'r+') as balances:
                ...
                try:
                    pdata_path = r'C:\Users\skyler\AppData\Roaming\.minefabricnew\minescript\system\exec\Bot\pdata.json'
